(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Thor = factory());
	...
	*/
	...
	var Head = /*#__PURE__*/function (_SvelteComponent) {
	  _inherits(Head, _SvelteComponent);

	  var _super = _createSuper$2(Head);
	...
	*/
	...
	var getSymbol = function getSymbol(key) {
	  var min = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
	  var max = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 200;
	  var string = "".concat(key, "-").concat(new Date().getTime(), "-").concat(getRandom(min, max));
	  return Symbol(string);
	}; // symbol provated function

	var symbolPrivatedThor = getSymbol('thor');
	getSymbol('plugins'); // utils function

	var initPlugins = function initPlugins(plugins, value) {
	  if (Array.isArray(plugins) && plugins.length) {
	    var i = plugins.length;

	    while (i) {
	      var plugin = plugins[plugins.length - i];
	      value = plugin(value);
	      i--;
	    }
	...
	function create_fragment$1(ctx) {
	  ...
	  return {
	    c: function c() {
	      ...
	      t = space();
	      div0 = element("div");
	      attr(textarea, "class", "thor-inner");
	      textarea.value =
	      /*value*/
	      ctx[0];
	      attr(div0, "class", "thor-inner");
	      set_style(div0, "margin-top", "20px");
	      attr(div1, "class", "thor-body");
	    },
	    m: function m(target, anchor) {
	...
	function instance$1($$self, $$props, $$invalidate) {
	  ...
	  var setHtml = function setHtml() {
	    return $$invalidate(1, html = initPlugins(plugins, value));
	  };
	  ...
	  return [value, html, onInput, plugins];
	}

	var Body = /*#__PURE__*/function (_SvelteComponent) {
	  _inherits(Body, _SvelteComponent);

	  var _super = _createSuper$1(Body);
	...
	function create_fragment(ctx) {
	  ...
	  return {
	    ...
	    p: function p(ctx, _ref) {
	      ...
	      if (dirty &
	      /*value*/
	      1) body_changes.value =
	      /*value*/
	      ctx[0];
	      if (dirty &
	      /*plugins*/
	      2) body_changes.plugins =
	      /*plugins*/
	      ctx[1];
	...
	function instance($$self, $$props, $$invalidate) {
	  var value = $$props.value;
	  var plugins = $$props.plugins;
	  var _$$props$boxId = $$props.boxId,
	      boxId = _$$props$boxId === void 0 ? "thor-".concat(new Date().getTime(), "-").concat(Math.random()).replace(/\./, "") : _$$props$boxId;

	  $$self.$$set = function ($$props) {
	    if ("value" in $$props) $$invalidate(0, value = $$props.value);
	    if ("plugins" in $$props) $$invalidate(1, plugins = $$props.plugins);
	    if ("boxId" in $$props) $$invalidate(2, boxId = $$props.boxId);
	  };

	  return [value, plugins, boxId];
	}

	var Thor$1 = /*#__PURE__*/function (_SvelteComponent) {
	  _inherits(Thor, _SvelteComponent);

	  var _super = _createSuper(Thor);

	  function Thor(options) {
	    var _this;
