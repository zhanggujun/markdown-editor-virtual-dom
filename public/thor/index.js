...
(function (global, factory) {
	...
	*/
	...
	var Head = /*#__PURE__*/function (_SvelteComponent) {
	  ...
	  var _super = _createSuper$3(Head);
	...
	*/
	...
	var Thor$2 = /*#__PURE__*/function (_SvelteComponent) {
	  _inherits(Thor, _SvelteComponent);

	  var _super = _createSuper$1(Thor);
	...
	var plugin = function plugin(value) {
	  return marked(value);
	};

	var plugin2 = function plugin2(value) {
	  return marked("".concat(value, "<div style=\"color:#0000ff;\">\u91CD\u65B0\u6765\u8FC7\u54C7</div>"));
	};

	var Thor = /*#__PURE__*/function (_Core) {
	  _inherits(Thor, _Core);

	  var _super = _createSuper(Thor);

	  function Thor(el, options) {
	    _classCallCheck(this, Thor);

	    var plugins = [plugin, plugin2];

	    var merge = _objectSpread(_objectSpread({}, options), {}, {
	      plugins: plugins
	    });

	    return _super.call(this, el, merge);
	  }
